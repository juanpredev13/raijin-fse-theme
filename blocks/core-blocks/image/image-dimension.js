...
addFilter("blocks.registerBlockType", "raijinfse_barbone-core-blocks/image-height/add-attributes", addAttributes);
...
addFilter("editor.BlockEdit", "raijinfse_barbone-core-blocks/image-height/add-inspector-controls", addInspectorControl);

addFilter(
  "blocks.getEditWrapperProps",
  "raijinfse_barbone-core-blocks/image-size/add-wrapper-props",
...
addFilter(
  ...
  "raijinfse_barbone-core-blocks/image-size/add-front-end-class",
